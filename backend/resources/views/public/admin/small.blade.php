                ...
                <div role="tabpanel" class="tab-pane link_small_goods" id="link_small_goods">
                    ...
                    <div class="mylink-con" id="select-app-goods" style="height:266px;">
                        <div class="good" ng-repeat="good in searchGoods">
                            ...
                            <div class="choosebtn">
                                <a href="javascript:;" id="@{{good.id}}" ng-click="chooseLink(1, good.id)" data-href="/packageA/detail_v2/detail_v2?id=@{{ good.goods_id }}">
                                    详情链接
                                </a>
                                <br>
                            </div>
                            ...
                            @foreach ($first_category as $goodcate_parent)
                                <div class="mylink-line">
                                    ...
                                    <div class="mylink-sub">
                                        <a href="javascript:;" id="category-{{ $goodcate_parent['id'] }}" class="mylink-app-nav" ng-click="chooseLink(1, 'category-{{ $goodcate_parent['id'] }}')" data-href="{{ yzAppFullUrl('catelist/:id') }}">选择</a>
                                    </div>
                                </div>
                                <?php
                                $sub_level = null;
                                ...
                                @if (!is_null($sub_level))
                                    @foreach ($sub_level as $goodcate_chlid)
                                        <div class="mylink-line">
                                            ...
                                            {{ $goodcate_chlid['name'] }}
                                            <div class="mylink-sub">
                                                <a href="javascript:;" class="mylink-app-nav" data-href="{{ yzAppFullUrl('catelist/' . $goodcate_chlid['id']) }}">选择</a>
                                            </div>
                                        </div>
                                        <?php
                                        $third_level = null;
                                            ...
                                            @foreach ($third_level as $goodcate_third)
                                                @if ($goodcate_third['parent_id'] == $goodcate_chlid['id'])
                                                    <div class="mylink-line">
                                                        ...
                                                        {{ $goodcate_third['name'] }}
                                                        <div class="mylink-sub">
                                                            <a href="javascript:;" class="mylink-app-nav" data-href="{{ yzAppFullUrl('catelist/' . $goodcate_third['id']) }}">选择</a>
                                                        </div>
                                                    </div>
                                                @endif
                                            @endforeach
                ...
                success: function(data){
                    ...
                    if(data){
                        $.each(data,function(n,value){
                            ...
                            html+='<a href="javascript:;" class="mylink-app-nav" data-href="/packageA/detail_v2/detail_v2?id='+value.id+'">详情链接</a><br>';
