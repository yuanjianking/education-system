    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" >
        <div class="panel panel-default">
            ...
            <div class='panel-body'>
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">公众号支付后跳转链接</label>
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">小程序支付后跳转链接</label>
                    <div class="col-sm-9 col-xs-12">
                        <div class="input-group">
                            <input type="text" name="trade[min_redirect_url]" data-id="PAL-00012" class="form-control" placeholder="请填写指向的链接" value="{{$set['min_redirect_url']}}" />
                            <span class="input-group-btn">
                                    <button class="btn btn-default nav-app-link" type="button" data-id="PAL-00012" >选择链接</button>
                                </span>
                        </div>
                        <span class='help-block'>当用户下单支付后，跳转到指定的页面</span>
                    </div>
                </div>
                {{--<div class="form-group">--}}
