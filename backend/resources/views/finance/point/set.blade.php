                        ...
                        <div id='activation_time_week' @if($set['transfer_cycle'] != 1)style="display:none"@endif>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-xs-6">
                                    <div class='input-group'>
                                        <select name='set[transfer_time_week]' class='form-control' style="width: 188px;">
                                            @foreach($week_data as $key => $week)
                                                <option value='{{ $key }}' @if($key == $set['transfer_time_week']) selected @endif>
                                                    {{ $week }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class='input-group'>
                                    <select name='set[transfer_time_hour]' class='form-control' style="width: 188px;">
                                        ...
                                        @foreach($day_data as $key => $day)
                                            <option value='{{ $key }}' @if($key == $set['transfer_time_hour']) selected @endif>{{ $day }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                @else
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12" style="margin-top: 30px;">
                            <input type="hidden" name="set[transfer_love_rate]"
                                   value="{{ $set['transfer_love_rate'] }}">
                            ...
                            <div class="col-sm-2">
                                <select name="set[group_type]" class="form-control">
                                    @foreach($memberGroups as $v)
                                        <option value="{{$v['id']}}" @if($set['group_type']==$v['id']) selected @endif>{{$v['group_name']}}
                                            (发送消息通知)
                                        </option>
                                    @endforeach
                                </select>
