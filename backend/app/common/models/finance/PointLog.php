    ...
    public function getModeNameAttribute()
    {
        ...
        switch ($this->point_mode) {
            ...
            case (40):
                ...
                break;
            case (41):
                $mode_attribute = PointService::POINT_MODE_ROOM_MEMBER_ACTIVITY_POINTS_ATTACHED;
                break;
            case (42):
                $mode_attribute = PointService::POINT_MODE_ROOM_ACTIVITY_POINTS_ATTACHED;
                break;
            case (43):
                $mode_attribute = PointService::POINT_MODE_ROOM_ANCHOR_ACTIVITY_POINTS_ATTACHED;
                break;
            case (44):
                $mode_attribute = PointService::POINT_MODE_ROOM_REWARD_TRANSFER_POINTS_ATTACHED;
                break;
            case (45):
                $mode_attribute = PointService::POINT_MODE_ROOM_REWARD_RECIPIENT_POINTS_ATTACHED;
                break;
        }
