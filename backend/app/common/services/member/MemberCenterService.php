...
class MemberCenterService
{
   public function getMemberData($memberId)
   {
       ...
       $diyarr = [
           'tool'         => ['separate','elive','member_code','member_pay_code','signIndex'],
           'asset_equity' => ['integral', 'credit', 'asset', 'love', 'coin','froze','extension', 'dragon_deposit'],
           'merchant'     => ['supplier', 'kingtimes', 'hotel', 'store-cashier', 'cashier', 'micro', 'delivery_station', 'service_station', 'voice-goods', 'staging_buy_car', 'package_deliver','appointment','room-apply'],
           'market'       => [
               ...
               'declaration', 'distribution-order', 'video-share', 'pending_order', 'exchange','micro-communities','bonus-pool', 'advert-market','room'
           ]
       ...
       //预约
       if (app('plugins')->isEnabled('store-appointment')) {
           $data[] = [
               'name'  => 'appointment',
               'title' => '预约',
