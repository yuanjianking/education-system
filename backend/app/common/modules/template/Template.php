...
//            ],
        ...
        foreach ($plugins as $plugin) {
            $result = array_merge($result, (array)$plugin->app()->getTemplateItems());
        }
        return $result;
    }
    ...
    private function _getNoticeItems()
    {
        $result = [
            ...
            'room_become_anchor' => [
                'template_id_short' => 'OPENTM414204601',
                'title' => '成为主播通知',
                'first_color' => '#000000',
                'remark_color' => '#000000',
                'first' => '恭喜您成为[商城名称]主播！！',
            ...
            'room_promote_order' => [
                'template_id_short' => 'OPENTM416070450',
                'title' => '推广订单通知',
                'first_color' => '#000000',
                'remark_color' => '#000000',
                'first' => '直播间客户下单提醒',
                'data' => [
                    ...
                    3 => [
                        "keywords" => "keyword4",
                        "value" => "订单于[支付时间]已经支付，订单完成后您将获得[预计分红金额]元提成奖励！",
                        "color" => "#000000",
                    ],
                ],
                'remark' => '感谢您的付出，请再接再厉！',
            ...
            'room_apply_success' => [
                'template_id_short' => 'OPENTM416620550',
                'title' => '直播间申请通知',
                'first_color' => '#000000',
                'remark_color' => '#000000',
                'first' => '您的直播间申请已通过审核！！',
            ...
            'room_anchor_dividend' => [
                'template_id_short' => 'OPENTM402027183',
                'title' => '主播分红通知',
                'first_color' => '#000000',
                'remark_color' => '#000000',
                'first' => '恭喜您获得主播分红！',
            ...
            'room_play_notice' => [
                'template_id_short' => 'OPENTM410215617',
                'title' => '主播开播通知',
                'first_color' => '#000000',
                'remark_color' => '#000000',
                'first' => '您关注的直播已经开播了！！',
