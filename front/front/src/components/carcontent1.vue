<template>
  <div id="carcontent">
    <div class="branch"
         v-if="list.goo && list.set.cat_adv_img">
    ...
    <div class="sote"
      ...
      <ul>
        <li v-for="(item,i) in list"
            :key='i'
            @click="toCatelist(item.id, $event)">
          <div class="thumb"
               v-if="item.thumb">
            <img :src="item.thumb" />
          </div>
      ...
      <div class="sote"
        ...
        <ul v-if="item.has_many_children.length > 0">
          <li v-for="(catshop,i) in item.has_many_children"
              @click="toCatelist(catshop.id, $event)"
              :key='i'>
            <div class="thumb"
                 v-if="catshop.thumb">
    ...
    <template v-if="!list.goo">
      <template v-if="list.set">
        <div class="branch"
             v-if="list.set.cat_level == 2 && $store.state.category.adv_img">
