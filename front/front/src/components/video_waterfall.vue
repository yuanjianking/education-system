<template>
  <div id="video-list">
    ...
    <div class="video-list">
      ...
      <ul ref="newArray2"
          class="zq-waterfall-right-video">
        <li @click="toVideo(item)"
...
<script>
  export default {
    props: ["list","showLoading","card_id"],
    data() {
      return {
        newArray1: [],
        newArray2: [],
        ...
        if (list.length > index) {
          that.getImg(
            ...
            function(w, h, r) {
              ...
              if (document.getElementsByClassName("zq-waterfall-left-video")[0]) {
                boxA = document.getElementsByClassName("zq-waterfall-left-video")[0]
                  .clientHeight;
              }

              if (document.getElementsByClassName("zq-waterfall-right-video")[0]) {
                boxB = document.getElementsByClassName("zq-waterfall-right-video")[0]
                  .clientHeight;
              }
