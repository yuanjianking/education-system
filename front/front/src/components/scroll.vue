...
<style scoped>
    ...
    .icon-down-background{display:inline-block;width: 1.25rem;height: 1.25rem;background: no-repeat 50%;background-image:url('../assets/load-down.png');background-size:1rem;vertical-align: middle;-webkit-transition-duration: .3s;transition-duration: .3s;}
    .icon-up-background{display:inline-block;width: 1.25rem;height: 1.25rem;background: no-repeat 50%;background-image:url('../assets/load-down.png');background-size:1rem;vertical-align: middle;transform:rotate(180deg);-webkit-transition-duration: .3s;transition-duration: .3s;}
    ...
    .icon-loading{display:inline-block;width: 1.25rem;height: 1.25rem;background: no-repeat 50%;background-image:url('../assets/loading.png');background-size:1.25rem;vertical-align: middle;-webkit-animation: loadingCircle 1s infinite linear;animation: loadingCircle 1s infinite linear;}
