  ...
  <div :style="'background:'+datas.params.bgcolor">
    <div id="rush-buy">
      ...
      <div class="single-row"
           v-if="datas.params.style=='100%' && showTime(item.start_time)?true:false"
        ...
        <ul class="text">
          ...
          <li class="price">
            <span class="left"
              ...
              <font class="price-b"
                    v-if="!(item.min_price ==  item.max_price)"><small>￥</small>{{item.max_price}}</font>
            </span>
            <span class="left"
          ...
          <li class="rob">
            <span class="left"
                  v-if="datas.params.overage">仅剩<big>{{item.member_request}}</big>人成团</span>
            <button type="button"
        ...
        <dl class="list-box"
          ...
          <dt class="img"
            ...
            <div class="sale-img"
                 :class="datas.params.option"></div>
            <div class="time-box"
                 v-if="datas.params.countdown"><template v-if="new Date()>new Date(item.start_time)">
                <yd-countdown :time="item.end_time"></yd-countdown>
          ...
          <dd class="price"
            ...
            <span class="left"
                  ...
                  <div v-if="item.vip_level_status&&item.vip_level_status.status==1"
                    ...
                    <small>￥</small>{{item.vip_level_status.word}}
                  </div>
                  <span v-else>
                    <small>￥</small>{{item.min_price}}
                  </span>
            </span>
            <span class="right"
                  v-if="!(item.min_price ==  item.max_price)"><small>￥</small>{{item.max_price}}</span>
          </dd>
          <dd class="price"
              v-if="datas.params.price != '0' && datas.params.price == 2?true:false">
            <span class="left"
        ...
        <div class="list"
          ...
          <ul class="text">
            ...
            <li class="price"
                v-if="datas.params.price != '0' && datas.params.price == 2?true:false">
              <span class="price-a"
                    :style="'color:'+datas.params.titlecolor"><small>￥</small>{{item.vip_level_status&&item.vip_level_status.status==1?item.vip_level_status.word:item.min_price}}</span>
            </li>
            <li class="rob">
              <span class="left"
                    v-if="datas.params.overage">仅剩<big>{{item.member_request}}</big>人成团</span>
...
export default {
  ...
  methods: {
    buy(obj) {
      this.$router.push(this.fun.getUrl("GroupGoods", { id: obj.id }));
    },
    showTime(time) {
