...
<style lang="scss" rel="stylesheet/scss" scoped>
	#area{	text-align: left;padding: 0.625rem;
.fe-mod-3 h2 { padding: 0rem; margin: 0rem; font-size: 18px; font-weight: 100; img{vertical-align: middle;}}
.fe-mod-3 h4 {padding: 0rem;  margin: 0rem; font-size: 14px; font-weight: 100; padding-top: 0.1875rem;}	
.select_place_bg {position: fixed; top: 0rem; left: 0rem; width: 100%; height: 100%; background: rgba(12, 2, 2, 0.82); z-index: 2000; }
