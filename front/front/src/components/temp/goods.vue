                ...
                <div class="card-price"
                  ...
                  <div>
                    <span style="text-decoration: line-through; font-size: 12px; color: #808080;"
                      ...
                      <span v-if="parseInt(good.priceold)">￥{{ good.priceold }}</span><span v-if="!parseInt(good.priceold)" style="display: inline-block;"></span>
                    </span>
                ...
                <div class="price fe-mod-8-main-name">
                  <div v-show="datas.params.price != 0">
                    ...
                    <div class="p2"
                      ...
                      ">
                      <span v-show="parseInt(good.priceold)">￥{{ good.priceold }}</span>
                    </div>
                    <div class="p3"
                         v-show="datas.params.price == 3">
