        ...
        <ul class="text">
          ...
          <li class="price">
                        <span class="left" v-if="datas.params.price != '0' && datas.params.price == 1?true:false">
                                            <font class="price-a" :style="'color:'+datas.params.titlecolor"><small>￥</small>{{item.vip_level_status&&item.vip_level_status.status==1?item.vip_level_status.word:item.pricenow}}</font>
                                            <font class="price-b" :style="'color:'+datas.params.titlecolor"
                                                  v-if="!(item.pricenow ==  item.priceold)"><small>￥</small>{{ item.priceold }}</font>
                                        </span>
      ...
      <div class="double-row" v-if="datas.params.style=='49.5%'?true:false">
        <dl class="list-box" v-for="(item,i) in datas.data" :key='i' v-if="showTime(item.start_time)"
          ...
          <dd class="price" v-if="datas.params.price != '0' && datas.params.price == 1?true:false">
            <span class="left" :style="'color:'+datas.params.titlecolor"><small>￥</small>{{item.vip_level_status&&item.vip_level_status.status==1?item.vip_level_status.word:item.pricenow}}</span>
      ...
      <div class="three-row" v-if="datas.params.style=='33.3%'?true:false">
        <dl class="list-box" v-for="(item,i) in datas.data" :key='i' v-if="showTime(item.start_time)"
          ...
          <dt class="text">
            <h2 v-if="showTitle">{{item.name|escapeTitle}}</h2>
          <dd class="price" v-if="datas.params.price != '0' && datas.params.price == 1?true:false">
            <span class="price-a" :style="'color:'+datas.params.titlecolor"><small>￥</small>{{item.vip_level_status&&item.vip_level_status.status==1?item.vip_level_status.word:item.pricenow}}</span>
