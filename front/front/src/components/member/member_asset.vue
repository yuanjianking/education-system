<template>
  <div
    ...
    :style="{
      ...
      backgroundImage:
        'url(' + (Params.assetbg == '2' ? Params.bgimg : '') + ')',
  ...
  >
    <div class="extension_plate" v-if="Params.assetstyle == 1">
      ...
      <ul class="box"  id="template02">
        ...
        <li v-for="(item,i) in Order.more" :key='i' v-if="Order.more && Order.more.length > 0" @click="gotoUrl(item)">
...
#template02 {
  ...
  .icon-member_integral {
    background: url("../../assets/images/member/member_a(55).png") no-repeat
    center;
  ...
  .icon-member-credit01 {
    background: url("../../assets/images/member/member_a(44).png") no-repeat
    center;
    background-size: 1.75rem;
    width: 1.75rem;
    height: 1.75rem;
  ...
  .icon-number_assets{
    background: url("../../assets/images/member/member_a(69).png") no-repeat
    center;
    background-size: 1.75rem;
    width: 1.75rem;
    height: 1.75rem;
  ...
  .icon-member-exchange1 {
    background: url("../../assets/images/member/member_a(1).png") no-repeat
    center;
    background-size: 1.75rem;
    width: 1.75rem;
    height: 1.75rem;
  ...
  .icon-member-currency1 {
    background: url("../../assets/images/member/member_a(14).png") no-repeat
    center;
    background-size: 1.75rem;
    width: 1.75rem;
    height: 1.75rem;
  ...
  .icon-member-frozen1 {
    background: url("../../assets/images/member/member_a(7).png") no-repeat
    center;
    background-size: 1.75rem;
    width: 1.75rem;
    height: 1.75rem;
  ...
  .icon-member-extension1 {
    background: url("../../assets/images/member/member_a(38).png") no-repeat
    center;
    background-size: 1.75rem;
    width: 1.75rem;
    height: 1.75rem;
