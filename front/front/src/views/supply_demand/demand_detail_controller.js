        ...
        .then(
          response => {
            if (response.result === 1) {
              let purchasingDetails = response.data.purchasingDetails;
              this.datas = purchasingDetails.purchasing;
              this.product_describe = this.datas.product_describe.replace(/\n|\r/g,"<br/>");//文本域换行处理

              this.unit_price = purchasingDetails.unit_price;
              this.product_state = purchasingDetails.product_state;
              ...
              this.purchasing_count = purchasingDetails.purchasing_count;
              this.store_info.type_id = purchasingDetails.type_id;
              this.store_info.type_name = purchasingDetails.type_name
                ? purchasingDetails.type_name
                : "";
              this.store_info.id = purchasingDetails.id
                ? purchasingDetails.id
                : "0";
                // 电话号码
              this.mobile = this.datas.mobile?this.datas.mobile:this.datas.has_one_member.mobile;
