<template>
  <div id="supply" :class="[this.fun.getPhoneEnv() == 3 ? 'pcStyle' : '']">
    <c-title :hide="false" text="信息详情"></c-title>
    ...
    <div id="content">
      ...
      <div class="price-row" style="background:#fff">
        <div class="price">
          <div class="price-title">意向价格</div>
          <div class="price-num" style="color:#ff2c29">
            {{ datas.purchasing_price }} {{ unit_price[datas.unit_price] }}
          </div>
        </div>
        <div class="price">
          <div class="price-title">采购数量</div>
          <div class="price-num">
            {{ datas.purchasing_total }} {{ unit_price_word }}
          </div>
        </div>
        <div class="price">
          <div class="price-title">状态要求</div>
          <div class="price-num">
            {{
              datas.product_type == 2
                ? "不限"
                : product_state[datas.product_type]
            }}
          </div>
        </div>
        <div class="price">
          <div class="price-title">我的位置</div>
          <div class="price-num">{{ datas.province.n }} {{ datas.city.n }}</div>
        </div>
        <div class="price">
          <div class="price-title">产地要求</div>
          <div class="price-num">
            {{
              datas.origin_requirement == 0
                ? "国内"
                : datas.origin_requirement == 1
                ? "国外"
                : "不限"
            }}
          </div>
        ...
        <div class="member">
          <div class="left">
            ...
            <div class="name">
              ...
              <div class="message">
                <i class="iconfont icon-pinglun"></i>采购信息{{
                  purchasing_count
                }}条
              </div>
            </div>
...
<script>
import controller from "./demand_detail_controller";
