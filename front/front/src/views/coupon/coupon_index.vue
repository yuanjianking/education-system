    ...
    <mt-tab-container v-model="selected">
      ...
      <div class="coupon_card">
        <mt-tab-container-item id="1">
          <!--待使用-->
          <div class="coupon_voucher  bg_dong  newarrive" v-for='(item,index) in wait_used' :key='index'>
              ...
              <div class="coupon_voucher_main">
                ...
                <div class="coupon_voucher_right">
                  ...
                  <p class="coupon_voucher_range1" @click="presenter(item,index)" v-if="isPresenter">
                    <span>赠送<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></span>
                  </p>
                  <!-- 蓝色：bg_1，红色：bg_2 -->
                  ...
                  <p class="coupon_voucher_more on" @click='toggle($event,index)'>详细
                    <i class="fa coupon_voucher_more_arr"
                       :class="{'fa-angle-down':index==display,'fa-angle-right':index!=display}"></i>
        ...
        <mt-tab-container-item id="2">
          <div v-for='(item,index) in overdue' class="coupon_voucher  disabled expired" :key='index'>
            <mt-cell-swipe title="" :right="[{content: '删除', style: { background: 'red', color: '#fff' },
                      handler: () => {delteteItem(item,index)}}]">
              <div class="coupon_voucher_main">
                <div class="coupon_voucher_left">
        ...
        <mt-tab-container-item id="3">
          <!--已使用-->
          <div v-for='(item,index) in used' :key='index' class="coupon_voucher  disabled used">
            <mt-cell-swipe title="" :right="[{content: '删除', style: { background: 'red', color: '#fff' },
                      handler: () => {delteteItem(item,index)}}]">
              <div class="coupon_voucher_main">
                <div class="coupon_voucher_left">
