<template>
  <div class="cart"
    ...
    <mt-navbar v-model="tabActive" fixed style="top:40px;">
      <mt-tab-item id="rent"
          ...
          <div v-if="isShowListRent"
                  ...
                  <div class="info">
                    ...
                    <template v-if="item.goods.stock_status == 0">
                      <ul class="day"
                        ...
                        <li>
                          <span v-show="parseInt(item.goods.market_price)">吊牌价：￥{{ item.goods.market_price }}元</span>
                        </li>
                        <li v-if="
              ...
              <div class="left"
                ...
                <div class="goods-box">
                  ...
                  <div class="text">
                    ...
                    <ul class="sum">
                      <li>
                        <span v-show="parseInt(item.market_price)">吊牌价：￥{{ item.market_price }}元</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="cart_pay"
              ...
              <div class="paysub "
                ...
                结算<small class="total" style="font-size:12px">({{ rentCount }})
                </small>
              </div>
            </div>
          </div>
