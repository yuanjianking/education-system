    ...
    <c-title :hide="false" text="我的拍卖"></c-title>
      ...
      <div class="content">
          <template v-if="activeName==0||activeName==1">
              <div class="list" v-for="(item,index,key) in datas" :key="index" @click="toDetail(item)">
                <div class="image" v-if="item.goods" ><img :src="item.goods.thumb"></div>
                <div class="right">
                  <div class="title" v-if="item.goods">{{item.goods.title}}</div>
                  <div class="bottom">
                    <div class="cash" v-if="item.auction_goods_record"><span>当前价:</span><span>￥{{item.auction_goods_record.price}}</span></div>
            ...
            <template v-if="activeName==2" >
                    <van-swipe-cell v-for="(item,index,key) in datas" :key="index">
            ...
            <template v-if="activeName==3">
              <div class="list" v-for="(item,index,key) in datas" :key="index" @click="toDetail(item)">
                ...
                <div class="confirm" @click="toBuy(item)">
                  确认下单
                </div>
              </div>
            </template>
