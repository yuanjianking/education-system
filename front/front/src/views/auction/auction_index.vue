  ...
  <div id="auction_index" ref="auction_index">
    ...
    <div class="content">
      ...
      <van-swipe class="my-swipe"  indicator-color="white" :autoplay="3000">
        <van-swipe-item v-for="(item,index,key) in rotation" :key="index">
        <a :href="item.url">
            <img :src="item.img">
        </a>
        </van-swipe-item>
      ...
      <div class="introduce">
        ...
        <div class="good-list">
          <div class="good" v-for="(item,index,key) in recommend" :key="index" @click="introDetail(item)">
            <div class="image" >
                <img :src="item.thumb">
            </div>
            <div class="bottom">
      ...
      <div class="new">
          ...
          <div class="good-list">
            <div class="good" v-for="(item,index,key) in datas" :key="index" @click="toDetail(item)">
              <div class="image" >
                  <img :src="item.thumb">
              </div>
              <div class="bottom">
                ...
                <div class="cash">
                    <span>起拍价</span> 
                    <div class="money"><span style="font-size:12px;">￥</span><span>{{item.start_price?item.start_price
                      :0}}</span></div>
                </div>
              </div>
              <div class="time">
