<template>
  <div id="publish_first" ref="publish_first">
        ...
        <div class="item-upload">
         ...
         <div class="item-add">
            ...
            <div style="display: flex;flex-wrap: wrap;">
              <div class="add-spe" v-for="(item,index,key) in param" :key="index" style="margin-right:0.5rem;">
    ...
    <yd-popup v-model="show1" position="bottom" width="100%" height="100%">
    ...
    <yd-popup v-model="show3" position="center":close-on-masker="false" height="40%" width="70%">
      <div class="pop">
        <div class="top">
