  ...
  <div id="publish_second" ref="publish_second">
    ...
    <div class="content">
      ...
      <div class="item-special">
        <div class="title">
          <div><span>保证金</span><span style="color:#999999;">(预付款)</span></div>
          <div class="enp">
              <div class="enp-choose">
                <span v-for="(item,index) in primise"
                      :key="index"
      ...
      <div class="item-special">
        <div class="title">
          <div><span>{{endorsement_name}}</span><span style="color:#999999;">(预付款)</span></div>
          <div class="enp">
            <div class="enp-choose">
              <span v-for="(item,index) in daiyan"
                    :key="index"
                    @click="chooseEm(item)"
                    :class="[item.checked?'bg':'']">
                {{item.name}}
      ...
      <div class="item">
        ...
        <yd-cell-item arrow style="padding-left:0;">
            <span slot="left">开始时间:</span>
            <yd-datetime type="datetime" v-model="form.start_shooting" slot="right" :start-date="CurentTime()" ></yd-datetime>
        </yd-cell-item>
        <yd-cell-item arrow style="padding-left:0;">
            <span slot="left">结束时间:</span>
            <yd-datetime type="datetime" v-model="form.end_shooting" slot="right"  :start-date="CurentTime()"></yd-datetime>
        </yd-cell-item>
      </div>
      <div class="item">
