  ...
  <div id="make_appointment">
    ...
    <div class="top_main">
      ...
      <div class="cell">
        ...
        <van-cell v-if="chooseTechnician.name" title="预约技师" :value="chooseTechnician.name"/>
      </div>
    </div>
    ...
    <yd-popup v-model="showProjects" position="right" height="100%" width="100%">
      ...
      <div id="appointment_time">
        ...
        <div class="main" v-if="!isRest && start_time">
          <p class="tips" v-if="technician.length <= 0">暂无技师可预约</p>
          <p class="tips" v-else>选择技师</p>
          <div class="technician-list">
            <van-radio-group v-model="result" checked-color="#f4a82e">
              <template v-for="item in technician">
                <van-radio :name="item.id" v-if="item.status != 1" @click="clickTechnician(item)">
                ...
                <div class="technician-item" v-if="item.status == 1">
                  <p class="number">已约</p>
                  <div class="pic">
                    <img :src="item.thumb" alt="">
                  </div>
        ...
        <div class="project_list" v-for="item in store" :key="item.id" @click="chooseStore(item)">
          ...
          <div class="list_title">
            ...
            <div class="list_title_bottom">
              ...
              <div>
                <i style="color:#cccccc;" class="iconfont icon-order_locate"></i>
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  #make_appointment .top_main .goods {
    ...
    margin: 0 5% 0.875rem;
    padding: 0.825rem;
    box-shadow: 0px 0px 18px 0px rgba(169, 169, 169, 0.24);
    border-radius: 5px;
  }
