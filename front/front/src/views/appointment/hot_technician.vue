  ...
  <div id="hot-technician">
    ...
    <div class="technician-top" v-if="!search">
      ...
      <div class="three" v-if="three.name" @click="gotoWorker(three.id)">
        ...
        <div v-if="!three.thumb && second.name" style="position: absolute;z-index: 10;width: 100%; height: 100%; top: 0; background: #FFFFFF"></div>
      </div>
    </div>
    ...
    <template v-if="search">
      <div class="technician-list" v-for="(item, index) in projectList" :key="item.id">
        <div class="technician-item" @click="gotoWorker(item.id)">
