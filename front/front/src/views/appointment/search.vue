<template>
  <div id="appointment-search">
    <div class="search_box" :style="{width: fun.getPhoneEnv() == 3 ? '375px' : ''}">
      <ul class="search">
        <li class="left">
          ...
          <span @click.stop="showProject">{{status==="1"? "项目":"技师"}}</span>
          <i @click.stop="showProject" class="iconfont icon-member-bottom"></i>
          <div class="search-popup-box" v-if="show2">
            <div style="margin: 0.3rem 0.5rem;border-bottom: 1px solid #eeeeee"><p @click="selectType('1')">项目</p></div>
            <div style="margin: 0.3rem 0.5rem;"><p @click="selectType('2')">技师</p></div>
          </div>
        </li>
        <li class="right">
          <input
    ...
    <template v-if="status !== '2'">
      <div class="list">
        <div class="list-item" v-for="(item, index) in projectList" :key="item.id" @click="toUrl('ProjectDetails',{project_id: item.id})">
          <div class="item-left">
    ...
    <template v-if="status === '2'">
      <div class="technician-list" v-for="(item, index) in projectList" :key="item.id" @click="toUrl('TechnicianDetails',{worker_id:item.id})">
        <div class="technician-item">
          ...
          <div class="technician-right">
            ...
            <div class="describe1 text-over"><span class="blue">项</span>
