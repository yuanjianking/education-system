        ...
        <div class="shareholder-order">
            <div id="tabs">
                <mt-navbar v-model="activeName">
                    <mt-tab-item id="first" @click.native="handleClick('1')">全部</mt-tab-item>
                    <mt-tab-item id="second" @click.native="handleClick('2')">已发放</mt-tab-item>
                    <mt-tab-item id="third" @click.native="handleClick('3')">未发放</mt-tab-item>
                </mt-navbar>
