        ...
        <ul class="goods-box">
          <li v-for="(item, index) in listOne" :key="index">
            ...
            <div class="right">
              ...
              <p class="stock">补货价:<span class="price">￥{{item.show_price}}</span></p>
              <div class="ticket ">
                <p class="repertory text-over">规矩:{{item.has_many_options[0]?item.has_many_options[0].title:'无'}}</p>
                <div class="select">
