<template>
    <div id="Love_activation">
    	...
    	<p>激活{{love_name}}(元)</p>
    	<p id="money">{{usable}}<small></small></p>
    	<div class="tbs">
...
#Love_activation{
	...
	#money{
		background-color: #fff;
		color: #333;font-weight:bold;font-size: 28px;line-height: 3rem;
			small{
				font-size:14px;
	...
	.tbs{
        ...
        .lise{border-bottom: 0.0625rem solid #ebebeb;margin: 0.625rem 0;width: 100%;display: block;}
