    ...
    <div class="content">
      <div class="goods_list">
        <div class="goods_box">
          ...
          <ul class="goods_info">
            ...
            <li class="price">
              <span>¥</span>{{popPrice}}<span style="text-decoration:line-through;">¥{{info.has_one_group.max_price}}</span>
            </li>
            <li class="number">
              <div class="left">
      ...
      <div class="into_group">
        <template v-if="this.isOpen == 1&&this.action != 4">
          ...
          <p>拼团中，离成团还差<span>{{info.has_one_level.member_num-info.has_many_success_member_count}}</span>人</p>
        </template>
        <!-- <template v-if="this.isOpen != 1||this.action != 4"> -->
        <template v-else>
        ...
        <button type="button"
                ...
                @click="clickOpenGroup()">{{btnTest}}</button>
      </div>
      <div class="group_user"
        ...
        <div class="user_box"
          ...
          <div class="user"
               v-for="(ie,i) in (info.has_one_level.member_num-info.has_many_success_member_count)" :key='i'>
            <div class="img">
              <img src="">
            </div>
            <i class="iconfont icon-group_wenhao"></i>
      ...
      <div class="one_open">
        ...
        <div class="shopinfo noVantRadio"
          ...
          <dl v-for="(specs,i) in goodsInfo.has_many_specs" :key='i'
              v-if="goodsInfo.has_many_specs!==undefined&&goodsInfo.has_many_specs.length>0 ? 1 :0">
            <dt>{{ specs.title }}</dt>
            <dd>
