  ...
  <div id="transHome">
    ...
    <div class="notices" @click="toMore">
      <div class="notice_title">
        ...
        <!--<p v-show="false">火币：推出稳定币解决方案HUSD</p>-->
      </div>
      <div class="more" >
    ...
    <div class="content">
      <div class="trans_num">
        ...
        <p>
          <span><em class="small">￥</em><em>{{homeData.bonus_count || 0}}</em></span> <span>累计{{lang.bonus_name}}</span>
        </p>
      </div>
    </div>
...
<style lang="scss" rel="stylesheet/scss" scoped>
  #transHome {
    ...
    .notices {
      ...
      padding: .2rem;
      box-shadow: -0.125rem 0rem 0.2813rem 0.0313rem rgba(0, 0, 0, 0.06), 0rem 0.125rem 0.2813rem 0.0313rem rgba(0, 0, 0, 0.06);
