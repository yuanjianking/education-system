  ...
  <div id="set_password">
    ...
    <div id="password_one" v-if="!has_password">
      ...
      <div class="info">
        <ul class="info_a">
          ...
          <li>
            ...
            <!-- ↓↓关键代码是这里↓↓ -->
            <yd-sendcode slot="right" v-model="start1" @click.native="verificationCode" type="warning"
                         style="margin-left:-4rem;"></yd-sendcode>
            <!-- ↑↑关键代码是这里↑↑ -->
          </li>
        </ul>
        <ul class="info_b">
      ...
      <div class="btn" @click="setPassword">
        <yd-button type="large">确定</yd-button>
      </div>
    </div>
    ...
    <div id="password_two" v-if="has_password">
      ...
      <div class="btn" @click="forgetPassword">
        <yd-button type="large">忘记密码</yd-button>
      </div>
    </div>
  </div>
</template>
