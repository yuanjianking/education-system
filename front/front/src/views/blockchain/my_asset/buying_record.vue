  ...
  <div id="buying_record">
    ...
    <div id="content">
      ...
      <mt-loadmore :top-method="loadTop" topDropText='释放刷新' ref="loadmore">
          ...
          <div class="buy_info" v-if="chooseItem === 0">
            <div class="info_a">
              ...
              <ul class="number">
                ...
                <!--<li>累计售出：-{{recordData.sell_total}}</li>-->
              </ul>
            </div>
            <div class="info_b">
              <ul class="list" @click="toDetail(item,'buy')" v-for="(item,i) in recordList" :key='i'>
                ...
                <li>
                  ...
                  <span>{{lang.subscription_name}}（单价：¥{{item.price}}）</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="buy_info" v-if="chooseItem === 1">
            ...
            <div class="info_b">
              <ul class="list" @click="toDetail(item,'sell')" v-for="(item,i) in recordList" :key='i'>
                ...
                <li>
                  <span>{{item.created_at}}</span>
                  <span>{{item.status_name}}（单价：¥{{item.price}}）</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="buy_info" v-if="chooseItem === 2">
            ...
            <div class="info_b">
              <ul class="list" v-for="(item,i) in recordList" :key='i'>
                ...
                <li>
                  <span>{{item.created_at}}</span>
                  <span>{{item.category}}（含手续费：¥{{item.poundage}}）</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <transition name="fadeLeft">
          <!-- 奖励记录 -->
          <div class="buy_info" v-if="chooseItem === 4">
            <div class="info_a">
              <div class="classify">
                <h1>奖励记录</h1>
                <span @click="showClassify1">{{chooseClassifyName}}<i class="iconfont icon-down"></i></span>
        ...
        <transition name="fadeLeft">
          <!-- 激活记录 -->
          <div class="buy_info" v-if="chooseItem === 5">
            <div class="info_a">
              <div class="classify">
                <h1>激活记录</h1>
                <span @click="showClassify1">{{chooseClassifyName}}<i class="iconfont icon-down"></i></span>
        ...
        <transition name="fadeLeft">
          <!-- 分红记录 -->
          <div class="buy_info" v-if="chooseItem === 6">
            <div class="info_a">
              <div class="classify">
