    ...
    <div id="content">
      <div class="top">
        <ul class="box">
          ...
          <li>当前{{lang.sell_name}}价：¥{{digitization.digitization_price}}/单位</li>
        </ul>
      </div>
      ...
      <div class="sale_btn">
        <yd-button type="primary" @click.native="sale">确认{{lang.sell_name}}</yd-button>
      </div>
      ...
      <!-- <div class="discount">
        <ul class="list">
          <li>
            <span>可用10000.00积分抵扣10000元</span>
            <yd-switch v-model="switch1"></yd-switch>
          </li>
          <li>
            <span>可用1000.00爱心值抵扣1000元</span>
            <yd-switch v-model="switch1"></yd-switch>
          </li>
        </ul>
      </div> -->
      <!-- <div class="sub_btn">
        <p>合计：¥<span>5000.00</span></p>
