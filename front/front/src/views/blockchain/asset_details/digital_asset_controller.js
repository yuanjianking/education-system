      ...
      return [{
        ...
        "scene": {
          ...
          "sphereSource": {
            ...
            slices: this.getSphereSliceUrl(1)
          },
          // 立方体贴图的资源
          "cubeSource": {
            thumb: `${sourceRoot}/cubeSource/1/thumb.jpg`,
            slices: this.getCubeSliceUrl(1)
          },
          // 是否默认展示该场景
          "is_main": 1
        },
      ...
      },
        {
          "scene": {
            ...
            "sphereSource": {
              ...
              slices: this.getSphereSliceUrl(2)
            },
            "cubeSource": {
              thumb: `${sourceRoot}/cubeSource/2/thumb.jpg`,
              slices: this.getCubeSliceUrl(2)
            },
            "is_main": 0
          },
          "overlays": [{
