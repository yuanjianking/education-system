			...
			<div class="main">
				...
				<div class="new_extension">
					...
					<ul class="text">
						...
						<li v-if="becomeType_3 && !(fun.isTextEmpty(become_3_info_1))">
							...
							<p>本店累计消费满<span>{{become_3_info_1}}</span>  元， 才可成为推广员，您已消费<span>{{become_3_info_2}}</span>  元，请继续努力！</p>
						</li>
						<!--推广条件2   消费达到N次   -->
				...
				<!-- <div class="new_extension">
					...
					<ul class="text">
						<li>
							<i class="iconfont icon-finger"></i>
							<p>本店累计消费满<span>10,000.00</span>  元， 才可成为推广员，您已消费<span>0</span>  元，请继续努力！</p>
						</li>
						<li>
							<i class="iconfont icon-finger"></i>
