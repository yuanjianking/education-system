  ...
  <div id="custom_queue">
    ...
    <div class="content">
      ...
      <div class="reward_box">
        <ul class="reward_a">
          <li><span>¥</span>{{ rewardsData.amountTotal || 0 }}</li>
          <li>累计奖励</li>
        </ul>
        <ul class="reward_b">
          <li><span>¥</span>{{ rewardsData.amountSurplusTotal || 0 }}</li>
          <li>待奖励</li>
        </ul>
      </div>
            ...
            <div class="queue_b">
              <div class="queue_center">
                ...
                <ul class="reward_queue_b">
                  <li><span>¥</span>{{ item.finish_amount }}</li>
                  <li>已奖励</li>
                </ul>
          ...
          <div class="queue_box"
            ...
            <div class="queue_b">
              <div class="queue_center"
                ...
                <ul class="reward_queue_a">
                  <li><span>¥</span>{{ item.has_one_queue.finish_amount }}</li>
                  <li>已奖励金额</li>
                </ul>
                <ul class="reward_queue_b">
                  <li><span>¥</span>{{ item.has_one_queue.surplus_amount }}</li>
                  <li>未奖励金额</li>
                </ul>
                <ul class="reward_queue_c">
