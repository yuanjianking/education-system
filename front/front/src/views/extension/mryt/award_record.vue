    ...
    <div id="content">
      ...
      <div class="award_box">
        <mt-navbar v-model="activeName">
          <mt-tab-item id="-1" @click.native="getTab">全部</mt-tab-item>
          <mt-tab-item id="1" @click.native="getTab">已发放</mt-tab-item>
          <mt-tab-item id="0" @click.native="getTab">未发放</mt-tab-item>
        </mt-navbar>
    ...
    #content {
      .info_box {
        ...
        .info {
          ...
          padding: 0.75rem 0;
          display: flex;
          ul:first-child, ul:nth-child(2), ul:nth-child(3) {
            width: 5.125rem;
            li {
