  ...
  <div id="mryt">
    ...
    <div id="content">
      ...
      <div class="list_info">
        ...
        <ul>
          <li>{{rewardsData.team_amount||0}}<span>元</span></li>
          <li>{{setLang.team_name || '团队奖'}}</li>
        </ul>
        <ul>
          <li>{{rewardsData.thank_amount||0}}<span>元</span></li>
        ...
        <ul>
          <li>{{rewardsData.amount||0}}<span>元</span></li>
          <li>{{setLang.referral_name || '直推奖'}}</li>
        </ul>
        <ul>
          <li>{{rewardsData.tier_amount||0}}<span>元</span></li>
      ...
      <div class="reward_item">
        <ul class="reward">
          <li>累计总奖励</li>
          <li>{{rewardsData.all_amount}}<span>元</span></li>
        </ul>
        <div class="item_box">
