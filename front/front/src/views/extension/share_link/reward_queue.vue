  ...
  <div id="reward_queue"
    ...
    <div id="reward_header">
      ...
      <div class="reward_box">
        <ul class="reward_a">
          <li><span>¥</span>{{summarizing.finish_total}}</li>
          <li>累计奖励</li>
        </ul>
        <ul class="reward_b">
          <li><span>¥</span>{{summarizing.surplus_total}}</li>
          <li>待奖励</li>
        </ul>
        <ul class="reward_c"
            @click="toDetail">
    ...
    <div id="queue_content">
      <mt-navbar v-model="chooseName">
        <mt-tab-item id="queue"
                     @click.native="handleClick1">奖励队列</mt-tab-item>
        <mt-tab-item id="record"
                     @click.native="handleClick1">奖励记录</mt-tab-item>
      </mt-navbar>
        ...
        <mt-tab-container-item id="queue">
          ...
          <div id="tabs_b"
            ...
            <mt-navbar v-model="activeName"
                       v-show="summarizing.goods_queue_count>-1">
              <mt-tab-item id="shop"
                           @click.native="handleClick">{{'商品（'+summarizing.goods_queue_count+'）'}}</mt-tab-item>
              <mt-tab-item id="store"
                           @click.native="handleClick">{{'门店（'+summarizing.store_queue_count+'）'}}</mt-tab-item>
              <mt-tab-item id="cashier"
                           @click.native="handleClick">{{'收银台（'+summarizing.cashier_queue_count+'）'}}</mt-tab-item>
            </mt-navbar>
                  ...
                  <transition name="fade">
                    <div class="button_box"
                      ...
                      <div class="queue_bottom">
                        <yd-button v-if="item.button.exchange"
                                   class="button_side"
                                   @click.native="exchange(item)">
                          {{item.button.exchange.name}}
                        </yd-button>
                        <yd-button v-if="item.button.process"
                                   class="button_side"
                                   @click.native="toProcess(item)">
                          {{item.button.process.name}}
                        </yd-button>
                        <yd-button v-if="item.button.exchange_log"
                                   class="button_side"
                                   @click.native="exchangeLog(item)">
          ...
          <div class="queue_box"
            ...
            <div class="queue_b">
              ...
              <div class="queue_center">
                ...
                <ul class="reward_queue_b">
                  <li><span>¥</span>{{item.amount_surplus}}</li>
                  <li>未奖励数量</li>
                </ul>
                <ul class="reward_queue_c">
                  <li>{{item.status_name}}</li>
    ...
    <yd-popup v-model="show3"
      ...
      <div class="queue_type">
        ...
        <yd-button class="queue_btn"
                   @click.native="SureExchange">确认兑换</yd-button>
      </div>
    </yd-popup>
    <!-- end -->
    ...
    <yd-popup v-model="show1"
      ...
      <div class="prize_box">
        ...
        <div class="prize_btn">
          <yd-button @click.native="sureTake()">确认抽奖</yd-button>
    ...
    <yd-popup v-model="show2"
      ...
      <div class="prize_box">
        ...
        <yd-button class="ture_btn"
                   @click.native="show2 = false">确认</yd-button>
      </div>
    </yd-popup>
    <!-- end -->

    <!-- 查看兑换记录弹窗 -->
    <yd-popup v-model="show4"
              position="bottom"
              height="60%">
      <div class="reward_record"
        ...
        <yd-button class="button"
                   @click.native="show4 = false">关闭</yd-button>
      </div>
    </yd-popup>
    <!-- end -->
  </div>
