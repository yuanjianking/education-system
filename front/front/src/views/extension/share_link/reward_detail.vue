    ...
    <div id="content_box">
      <div class="box">
        <ul class="data_line">
          <li class="data_a">
            <ul>
              <li><span>¥</span>{{amount_total.sum}}</li>
              <li>{{amount_total.name}}</li>
            </ul>
          </li>
          <li class="data_a">
            <ul>
              <li><span>¥</span>{{amount_surplus.sum}}</li>
        ...
        <ul class="data_line">
          <li class="data_a">
            <ul>
              <li><span>¥</span>{{amount_finish.sum}}</li>
              <li>{{amount_finish.name}}</li>
            </ul>
          </li>
          <li class="data_a">
            <ul>
              <li><span>¥</span>{{exchange_point.sum}}</li>
        ...
        <ul class="data_line">
          <li class="data_a">
            <ul>
              <li><span>¥</span>{{exchange_love.sum}}</li>
              <li>{{exchange_love.name}}</li>
            </ul>
          </li>
          <!-- <li class="data_a">
              <ul>
                  <li><span>¥</span>1252.25</li>
                  <li>累计奖励</li>
              </ul>
          </li> -->
        </ul>
      ...
      <div class="center">
        <ul>
          <li>已{{exchange_point_amount.name}}：<span>¥{{exchange_point_amount.sum}}</span></li>
          <li>已{{exchange_love_amount.name}}：<span>¥{{exchange_love_amount.sum}}</span></li>
        </ul>
      </div>
      <div class="tips">
        <ul>
