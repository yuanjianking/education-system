  ...
  <div id="dealer_award">
    ...
    <div class="header">
        <ul class="box">
            ...
            <li class="right">
                <span class="right_a line"><font>¥</font>{{total_dividend}}</span>
    ...
    <div class="title">
     ...
     <mt-loadmore :top-method="loadTop" ref="award_loadmore" id="olis" v-if="!isShowNoTest">
    <div class="reward_list">
        <ul class="wrapper-box">
            <li class="box" v-for="(item,index,key) in award" @click="detailTo(item.id)" :key='index'>
            <div>
