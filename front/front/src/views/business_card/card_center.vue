<template>
  <div id="card_conter">
    <mt-header fixed title="名片中心">
      <mt-button icon="back" @click="gotoMember" slot="left"></mt-button>
    </mt-header>
    <div class="card_a">
          ...
          <ul class="name">
            <li class="name_a">
              ...
              <div class="name_a_right">
                ...
                ></i>
                <span>{{ cardMessage.card_statistics.collection }}人收藏</span>
              </div>
            </li>
            <li class="name_b">
...
#card_conter {
  ...
  .card_a {
    ...
    .header_box {
      ...
      box-shadow: 0rem 0.219rem 0.844rem 0rem rgba(0, 0, 0, 0.14);
