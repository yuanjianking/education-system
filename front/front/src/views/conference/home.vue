        ...
        <div id="tool">
          ...
          <template v-if="item.is_enrol==0">
            ...
            <h3 class="c-button"
              ...
              <mt-button size="small"
                         type="danger"
                         disabled>报名人数已满，请等待下次活动或者选择其他活动</mt-button>
            </h3>
            <!-- 未报名 已结束-->
            <h3 class="c-button"
              ...
              <mt-button size="small"
                         type="danger"
                         disabled>活动已过期，请等待下次活动或者选择其他活动</mt-button>
            </h3>
          </template>
          <!-- 已报名 -->
          <template v-else-if="item.is_enrol==1">
            ...
            <h3 class="c-button"
              ...
              <mt-button size="small"
                         type="danger"
                         @click="onActivityInfo(item.id)">已报名，点击查看报名信息</mt-button>
            </h3>
            <!-- 已报名 已结束-->
            <h3 class="c-button"
                v-else-if="item.is_end==1">
