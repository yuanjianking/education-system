<template>
  <div id="enterprise">
    ...
    <div class="content">
      ...
      <mt-navbar v-model="enterpriseBaseActiveName">
        <mt-tab-item id="enterprise"
                     @click.native="enterpriseBaseHandleClick('0')">招商员</mt-tab-item>
        <mt-tab-item id="enterprise_centre"
                     @click.native="enterpriseBaseHandleClick('1')">招商中心</mt-tab-item>
      </mt-navbar>
      <mt-tab-container v-model="enterpriseBaseActiveName">
          ...
          <template>
            <div class="share_holder">
              <div class="header_box">
                ...
                <ul class="left">
                  <li class="lf"
                      style="line-height:3rem;text-align:center;">{{erchants_name}}</li>
                </ul>
                <ul class="right">
                  <li class="rt"
                      v-if="enterprise_level_li"><span>{{enterprise_level_title}}</span> <br /><span>分红比例:{{enterprise_level_li}}% </span>
                  </li>
                  <li v-if="!enterprise_level_li"
                      style="margin-top: 15px;"><span>分红比例:{{erchants_ratio}}% </span></li>
                </ul>
              </div>
            ...
            <div class="contentDetail">
              <mt-navbar v-model="enterpriseActiveName">
                <mt-tab-item id="enterprise_first"
                             @click.native="enterpriseHandleClick('0')">全部</mt-tab-item>
                <mt-tab-item id="enterprise_second"
                             @click.native="enterpriseHandleClick('1')">已结算</mt-tab-item>
                <mt-tab-item id="enterprise_third"
                             @click.native="enterpriseHandleClick('2')">未结算</mt-tab-item>
              </mt-navbar>
        ...
        <mt-tab-container-item id="enterprise_centre">
          ...
          <template>
              ...
              <div class="header_box">
                <ul class="left">
                  <li class="lf"
                      ...
                      v-if="enterpriseCenterInfo_1.has_one_level">{{enterpriseCenterInfo_1.realname}}</li>
                </ul>
                <ul class="right">
                  <li class="rt"
                      v-if="enterpriseCenterInfo_1.has_one_level">{{enterpriseCenterInfo_1.has_one_level.level_name}} <br />分红比例:{{enterpriseCenterInfo_1.has_one_level.bonus_ratio}}%
                  </li>
                </ul>
              </div>
            ...
            <div class="contentDetail">
              <mt-navbar v-model="enterpriseCenterActiveName">
                <mt-tab-item id="enterprise_center_first"
                             @click.native="enterpriseCenterHandleClick('0')">全部</mt-tab-item>
                <mt-tab-item id="enterprise_center_second"
                             @click.native="enterpriseCenterHandleClick('1')">已结算</mt-tab-item>
                <mt-tab-item id="enterprise_center_third"
                             @click.native="enterpriseCenterHandleClick('2')">未结算</mt-tab-item>
              </mt-navbar>
