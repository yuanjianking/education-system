<template>
  <div id="search3"
    ...
    <div id="soso"
         class="uou"
         :class="{'mout':amout}">
      <div class="search set-pc-style">
        <mt-button slot="prepend"
                   icon="back"
                   style="background: #fff;box-shadow: none; margin-top: -0.1rem;"
    ...
    <div class="page-loadmore-wrapper"
      ...
      <mt-loadmore :top-method2="loadTop"
                   ...
                   bottomDropText='下拉加载...'
                   bottomLoadingText=''>
        <c-goodsList :isSelect="$route.params.isSelect"
                     :num='0'
                     @selectTotal="changeTotal"
                     :goods='datas'
                     text='搜索结果'
                     class='osll'
                     :loading='loading'
                     :selectedGoods='setData'></c-goodsList>

      </mt-loadmore>
    </div>

    <div class="bottom set-pc-style">
      <i>
        已选&nbsp;
