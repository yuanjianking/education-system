  ...
  <div id="course">
    ...
    <div class="search">
      <input
        ...
        @click="moreGoods('all')"
      />
      <yd-icon slot="icon" class="icon-sousuo" custom size="16px"
               color="#c9c9c9"
               style="position:absolute;right:2.25rem;z-index:8888;"></yd-icon>
    </div>
    <div class="tupian" style="">
      <yd-slider autoplay="3000" v-if="showCarousel" style="">
        <yd-slider-item v-for="(item,i) in carouselInfo" :key='i'>
...
<!--          </ul>-->
    ...
    <div class="recommend_List">
      <ul :style="{marginLeft:-listMarginLeft+'rem' }" @touchstart="recommend_startBtn" @touchmove="recommend_moveBtn" @touchend="recommend_endBtn">
        <li :class="[i==activeIndex?'active':'']" v-for="(item,i) in recGoodList" @click.stop="goToDetail(item.goods_id)">
...
<!--                ¥ <span class="cost2">{{ item.vip_level_status.word }}</span>-->
<!--              </div>-->
<!--              <div class="right" v-else>¥ {{ item.price }}</div>-->
            </div>
          </div>
        </li>
      </ul>
...
<!--                ¥ <span class="cost1">{{ item.vip_level_status.word }}</span>-->
<!--              </li>-->
<!--              <li class="cost" v-else>¥ {{ item.price }}</li>-->
<!--            </ul>-->
<!--          </li>-->
<!--        </div>-->
        ...
        <li v-for="(item,i) in hotGoodList" :key='i' @click="goToDetail(item.goods_id)">
          ...
          <div class="hot_bottom">
              ...
              <div class="bottom">
                ...
                <div class="left" v-else>¥ {{ item.price }}</div>
...
<!--    <yd-cell-group-->
<!--      style="margin-top:0.375rem;margin-bottom:0rem;"-->
<!--      v-if="showHot"-->
<!--    >-->
...
<!--            </div>&ndash;&gt;-->
<!--    </div>-->
    <div class="carefully_chosen_more"  @click="moreGoods('')">
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .recommend_List{
    ...
    ul{
      ...
      li{
        ...
        background-color: #fff;
        width: 10.25rem;
        box-shadow: 0.119rem 0.147rem 0.219rem 0rem
  ...
  .hot_lsit{
    ...
    li{
      background: #fff;
      width: 10.25rem;
      box-shadow: 0rem 0rem 0.219rem 0rem
