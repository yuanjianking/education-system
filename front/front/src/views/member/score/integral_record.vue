    ...
    <div id="content">
      ...
      <div class="list_box">
        <mt-navbar v-model="activeName">
          <mt-tab-item id="first" @click.native="handleClick('0')">全部</mt-tab-item>
          <mt-tab-item id="second" @click.native="handleClick('1')">已领取</mt-tab-item>
          <mt-tab-item id="third" @click.native="handleClick('2')">使用中</mt-tab-item>
          <mt-tab-item id="fourth" @click.native="handleClick('3')">已使用</mt-tab-item>
          <mt-tab-item id="five" @click.native="handleClick('4')">已过期</mt-tab-item>
        </mt-navbar>
