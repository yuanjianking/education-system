    ...
    <div style="height: 40px;">
        ...
        <div class="content">
            <mt-navbar v-model="activeName">
                <mt-tab-item id="first" @click.native="handleClick('0')">信用值奖励记录</mt-tab-item>
                <mt-tab-item id="second" @click.native="handleClick('1')"  v-if="false">奖励</mt-tab-item>
                <mt-tab-item id="third" @click.native="handleClick('2')"  v-if="false">奖励</mt-tab-item>
            </mt-navbar>
