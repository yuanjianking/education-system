<template>
  <section id="goods-class">
        ...
        <div class="more"
          ...
          <ul>
            <li @click.stop="classifyRoute(1,2,index1)">
              <yd-icon class="iconfont icon-add"
                       custom
                       color="#fff"
                       size="1.125rem"></yd-icon>
              <span>添加</span>
            </li>
            <li @click.stop="classifyRoute(2,1,index1)">
              <yd-icon class="iconfont icon-edit"
                       custom
                       color="#fff"
                       size="1.125rem"></yd-icon>
              <span>编辑</span>
            ...
            <li @click.stop="deleteClassify(1,index1)">
              <yd-icon class="iconfont icon-delete"
                       custom
                       color="#fff"
                       size="1.125rem"></yd-icon>
              <span>删除</span>
          ...
          <div class="icon">
            <yd-icon class="iconfont icon-up"
                     custom
                     size="1.5rem"></yd-icon>
          </div>
        </div>
    ...
    <section id="bottom"
      ...
      <button type="button"
              @click="addClassify"><i class="iconfont icon-life-game-plus"></i>添加分类</button>
    </section>
