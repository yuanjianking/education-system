<template>
  <div id="coupon_management">
    ...
    <section id="release-goods">
     ...
     <mt-loadmore :top-method="loadTop" ref="coupon_loadmore" id="olis" v-if="!isShowNoTest">
    <div class="coupon_list">
        <div class="coupon_box" v-for="(item,index,key) in coupon" :key="index">
              ...
              <div class="more" v-show="item.edit_active">
                <ul>
                  ...
                  <li @click="provide(item.id)">
                    <yd-icon class="iconfont icon-grant" custom color="#fff" size="1.125rem"></yd-icon>
                    <span>发放</span>
                  </li>
                </ul>
                <div class="icon">
