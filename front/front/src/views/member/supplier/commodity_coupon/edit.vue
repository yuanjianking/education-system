      ...
      <div class="coupon_condition">
        ...
        <ul class="list">
          ...
          <li class="fenleisort"
            ...
            <span>添加的分类</span>
            <div class="item">
              <p v-for="(item,index,key) in fenleirange"
                 :key="item"><span class="name">{{item.name}}</span><span class="delete"
          ...
          <li class="fenleisort"
            ...
            <span>添加的分类</span>
            <div class="item">
              <p v-for="(item,index,key) in category"
                 :key="item"><span class="name">{{item.name}}</span><span class="delete"
          ...
          <li class="goodssort"
            ...
            <span>添加的商品</span>
            <div class="item">
              <p v-for="(item,index,key) in goodsrange"
                 :key="item"><span class="name">{{item.title}}</span><span class="delete"
          ...
          <li class="goodssort"
            ...
            <span>添加的商品</span>
            <div class="item">
              <p v-for="(item,index,key) in goods"
                 :key="item"><span class="name">{{item.title}}</span><span class="delete"
        ...
        <div class="select_box">
          ...
          <div class="list">
            <van-radio-group v-model="level_limit"  checked-color="#f15353">
              ...
              <van-radio v-for="(item,index,key) in Vip"
        ...
        <div class="selectBox">
          ...
          <div class="list">
            <van-checkbox-group v-model="fenleiSelect">
              <van-checkbox v-for="(item,index,key) in sousuoInfo"
                            :key="item"
                            :name="item"
        ...
        <div class="selectBox">
          ...
          <div class="list">
            <van-checkbox-group v-model="goodsSelect">
              <van-checkbox v-for="(item,index,key) in goodsSousuo"
                            :key="item"
                            :name="item"
