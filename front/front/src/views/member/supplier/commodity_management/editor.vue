<template>
  <section id="goods-edit">
        ...
        <yd-tab-panel label="基本信息">
         <section id="edit-a">
            <mt-field
              label="商品名称:"
              placeholder="请输入商品名称"
              v-model="cargon_data.title"
            ></mt-field>
            <mt-field
              label="商品单位:"
              placeholder="请输入商品单位"
              v-model="cargon_data.sku"
            ></mt-field>
          </section>
          <section
            class="goods_class"
          ...
          <section id="edit-b">
            <div class="top">
              <div
                style="height:3.125rem;font-size:16px;text-align:left;line-height:3.125rem;padding-left: 10px;box-size: border-box;"
              >商品图片：
              </div>
              <div
          ...
          <section
            ...
            <section id="edit-c">
              <mt-field
                ...
                placeholder="请输入商品现价"
                type="number"
                v-model="cargon_data.price"
              ></mt-field>
              <mt-field
                label="商品原价:"
                placeholder="请输入商品原价"
                type="number"
                v-model="cargon_data.market_price"
              ></mt-field>
              <mt-field
                label="商品成本:"
                placeholder="请输入商品成本"
                type="number"
                v-model="cargon_data.cost_price"
              ></mt-field>
            </section>
            <section id="edit-d">
              <mt-field
    ...
    <!-- 弹窗 -->
                    <yd-popup v-model="show1" position="bottom" height="80%" width="100%">
                    ...
                    <yd-popup v-model="show2" position="bottom" height="80%" width="100%">
                        <div class="select_box">
                            <div class="title">
                                <h2>会员组浏览权限</h2>
                                <i class="iconfont icon-guanbi"></i>
