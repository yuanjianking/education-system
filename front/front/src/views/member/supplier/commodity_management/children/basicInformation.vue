...
<div id="basicInformation" :class="{supplierClass:this.$route.params.store == 'supplier'}">
    ...
    <section id="edit-b">
      <div class="top">
        <!-- setting sun -->
        <div
          style="height:3.125rem;text-align:left;line-height:3.125rem;padding-left: 10px;box-size: border-box;"
        >
    ...
    <section id="edit-c">
      <ul class="number_power">
        ...
        <li>
          <span>商品成本:</span>
          <input type="number" v-model="cargon_data.cost_price" placeholder="请输入商品原价" @blur="clearSrcoll()">
        </li>
      </ul>
    </section>
    <section id="edit-d">
