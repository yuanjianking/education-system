...
<template>
  <div id="Shareholder_reward">
    <c-title :hide="false"
             :text="!fun.isTextEmpty(rewards.name)?rewards.name:''"></c-title>
        ...
        <div class="list_box">
          <ul class="box">
            <li v-for="(item,index) in recordsList"
              ...
              <div v-for="(item_child,indexs) in item.has_many_reward_log"
                   :key="indexs"
                   class="boxs">
                <div class="box-child">
                  <span>订单号:{{item_child.order_sn}}</span>
                  <span style="color:#ffbe5a">￥{{item_child.amount}}</span>
                </div>
                <div class="box-child">
    ...
    <img src="../../../../assets/images/no-more-product.png"
         alt=""
         style="width:5rem;margin-top:4rem;"
