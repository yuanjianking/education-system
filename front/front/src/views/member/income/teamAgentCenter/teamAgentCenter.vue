    ...
    <div class="share_holder">
      ...
      <div class="code_box">
        ...
        <router-link :to="fun.getUrl('TeamClient')" v-if="is_customer != 1">
          <div class="list1 code">
            <div class="ico extension"></div>我的客户
        ...
        <router-link :to="fun.getUrl('teamPerformance')" v-if="is_team_data != 1">
          <div class="list1 code">
            <div class="ico extension"></div>
            团队业绩(订单金额：{{
            teamPerformance.team_order_price || 0
            }}
            商品销量：{{ teamPerformance.team_goods_total || 0 }})
            <i
    ...
    <div class="content">
      <mt-navbar v-model="activeName">
        <mt-tab-item
          ...
          v-if="bonus_active"
        >{{ bonus_lable }}</mt-tab-item>
        <mt-tab-item
          id="second"
          @click.native="handleClick('1')"
          v-if="leveling_active"
        >{{ leveling_label }}</mt-tab-item>
        <mt-tab-item
          id="third"
          @click.native="handleClick('2')"
          v-if="prize_active"
        >{{ prize_label }}</mt-tab-item>
        <mt-tab-item
          id="four"
          @click.native="handleClick('3')"
          v-if="extra_active"
        >{{ extra_label }}</mt-tab-item>
      </mt-navbar>
                ...
                <div class="detail">
                  ...
                  <div class="info" v-for="(item,index2) in elem.has_many_dividend" :key='index2'>
                    ...
                    <div class="order_detail" :class="{'opens':index1==display1&&index2==display2}" v-if="is_team_order_details==1||is_team_buyer==1">
                        ...
                        <div class="team_goods" id="distribution-goods" :key='i' v-for="(goods,i) in item.order_goods" v-if="is_team_order_details==1">
                            <div class="img">
                                <img :src="goods.thumb">
                            </div>
                            <div class="inner">
                ...
                <div class="detail">
                  ...
                  <div class="info" v-for="(item,index2) in elem.has_many_dividend" :key='index2'>
                    ...
                    <div class="order_detail" :class="{'opens':index1==display1&&index2==display2}" v-if="is_team_order_details==1||is_team_buyer==1">
                        ...
                        <div class="team_goods" :key='i' id="distribution-goods" v-for="(goods,i) in item.order_goods" v-if="is_team_order_details==1">
                            <div class="img">
                                <img :src="goods.thumb">
                            </div>
                            <div class="inner">
