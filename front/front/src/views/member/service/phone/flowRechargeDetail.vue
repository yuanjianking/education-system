...
<style  lang="scss" rel="stylesheet/scss" scoped>
	#rechargeDetail{
		font-size: 12px;
 		.main{
 			.bott{background: #FFF;}
 			ul{display: flex;align-items: center;background: #FFF;margin-bottom: 0.625rem;
 				li{flex: 2; line-height: 1.5rem;text-align: left;padding: 0 0.625rem;box-sizing: border-box;}
 			}
 		}
 		#bts{position: fixed;bottom: 0;width: 100%;background: #FFF;line-height: 2rem;z-index: 9;height: 2.7rem;text-align: right;
 			button{ height: 1.5rem; margin:0 0.625rem;background: #fff;padding: 0 0.625rem;margin-top: 0.625rem; border-radius: 0.3125rem;color: #5f6e8b;
    line-height: 1.5rem; border: 0.0625rem solid #5f6e8b;}
 		}
	}
</style>-->
