<template>
	<div id="trainOrderDetail"  :class="'trainOrderDetail'+$store.state.service.lang">
		...
		<div class="orderStates">
			<div class="booking"> <span class="state">订票成功</span> <span class="right"><font>¥</font>750</span> </div>
		...
		<div class="orderContent">
			...
			<p class="order gift"> <span class="left">{{language.giftPoints}}</span> <b class="right">{{language.orderAfter}}&nbsp;<font>200</font>&nbsp;{{language.score}}</b></p>
			...
			<p class="order total"> <b><span class="left">{{language.total}}¥705</span></b> <span class="right">{{language.toPay}}</span> </p>
		</div> 
		<!--明细-->
		<div class="modalDetail" v-show="details" @click="closeDetails">
			 <div class="modal-dialog" @click.stop>
				...
				<ul>
					...
					<li class="big"> <span class="left">{{language.all}}</span> <span class="right">¥850</span> </li>
	...
	.orderContent{
		...
		.passenger,.contact{
			...
			ul{
				flex: 1;
				li{
					border-bottom:0.0625rem solid #e5e5e5; margin-bottom: 0.3125rem; padding-bottom: 0.3125rem;
					p{color: #666; font-size: 12px;
					text-align: left;height: 1.375rem;line-height: 1.375rem;}
				}
				li:last-child{border-bottom: 0;}
			}
		}
		.passenger{padding-bottom: 0.9375rem;}
		.order{
			background: #fff;
			margin-top: 0.625rem;
			padding-left:0.875rem;
			...
			b.right{font-size: 14px; color: #8c8c8c;font-weight: normal;}
			span.right{
				color:#fff;
				background-color: #f15353;
			display: inline-block ; height: 2.8125rem;line-height: 2.8125rem; width: 6.875rem;}
		}
		.insurance{height: 2.8125rem; line-height: 2.8125rem;}
		.gift{height: 2.75rem; line-height: 2.75rem;padding-right:0.875rem;
			font{
				color:#f15353;
			}
		}
...
.trainOrderDetailwei{
	...
	.modal{
	    ...
	    .modal-dialog{
	        ...
	        position:relative;
	        .title{
	        	i{color:#FF951B;float: right; font-size: 1.5625rem;}
	            color:#666;
	         	font-weight: normal;
	            font-size: 14px;
	            line-height:2.1875rem;
	...
	.orderContent{
		.passenger,.contact{
			...
			ul{
				...
				order:1;
				li{
					border-bottom:1px solid #e5e5e5; margin-bottom: 0.3125rem; padding-bottom: 0.3125rem;
					p{color: #666; font-size: 12px;
					text-align: right; height: 1.375rem;line-height: 1.375rem;}
				}
				li:last-child{border-bottom: 0;}
			}
		}
		.passenger{padding-bottom: 0.9375rem; span{float: right;}}
		...
		.order{
			...
			span.right{-webkit-border-radius: 0.375rem;
			-moz-border-radius: 0.375rem;
			border-radius: 0.375rem; border:0.0625rem solid #FF951B; color:#FF951B;
			display: inline-block ; height: 1.75rem;line-height: 1.75rem; width: 4.375rem;margin-top: 1.25rem;}
		}
		.insurance{height: 2.8125rem; line-height: 2.8125rem;}
		.gift{height: 2.75rem; line-height: 2.75rem;padding-right:0.875rem;}
		.total{height: 4.0625rem;.left{ line-height: 4.0625rem;}}
		.refunds{
			span{
				height: 1.75rem;
				line-height: 1.625rem;
