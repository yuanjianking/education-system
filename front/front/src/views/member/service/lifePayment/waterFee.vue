		...
		<div class="maleall">
			<label for="male"
				...
				<!--<el-select v-model="provicevalue"-->
					...
					<!--</el-option>-->
				<!--</el-select>-->
				<van-button plain type="primary" style="border-radius: 5px; color: #1f2d3d;border:1px solid #bfcbd9;min-height:1rem;min-width: 14rem" @click="seleRegional">{{regional}}</van-button>
			</label>
		</div>
		<div class="maleall">
			<label for="male"
				...
				<!--<el-select v-model="cityvalue"-->
					...
					<!--</el-option>-->
				<!--</el-select> -->
				<van-button plain type="primary" style="border-radius: 5px; color: #1f2d3d;border:1px solid #bfcbd9;min-height:1rem;min-width: 14rem" :disabled="citynull" @click="seleRegional_1">{{regiona2}}</van-button>
			</label>
		</div>         	
