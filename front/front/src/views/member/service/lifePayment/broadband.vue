         ...
         <div class="content">
			<div class="maleall">
				<label for="male"
					...
					<!--</el-option>-->
				<!--</el-select>-->
					<van-button style="border-radius: 5px; color: #1f2d3d;border:1px solid #bfcbd9;min-height:1rem;min-width: 14rem"  plain type="primary" @click="seleRegional">{{regional}}</van-button>
				</label>
			</div>
			<div class="maleall">
				<label for="male"
					...
					<!--</el-option>-->
				<!--</el-select> -->
					<van-button style="border-radius: 5px; color: #1f2d3d;border:1px solid #bfcbd9;min-height:1rem;min-width: 14rem"  plain type="primary" :disabled="citynull" @click="seleRegional_1">{{regiona2}}</van-button>
				</label>
			</div>          	
