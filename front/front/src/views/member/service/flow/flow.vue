  ...
  <div id="flow"
    ...
    <div class="m-footer"
      ...
      <div class="integral"
        ...
        <div>
          <b>
            <!--{{language.score}}-->{{deductionName}}</b> <span>{{language.scoreTip1}}{{score}}{{language.scoreTip2}}{{scoreMoney}}{{language.yuan}}</span>
        </div>
        <mt-switch :class="{rt:$store.state.service.chinese,lf:!$store.state.service.chinese}"
                   v-model="useScore"></mt-switch>
      </div>
      ...
      <div class="amount"
        ...
        <button type="button"
                @click="goSubmit">{{language.btn}}</button>
    ...
    .traffic-box {
      ...
      li.active {
        ...
        u {
          ...
          top: 0;
          left: 0;
          background: url(../../../../assets/images/favourablE.png) no-repeat 0
            0;
        }
        i {
          width: 1.875rem;
          ...
          right: 0;
          bottom: 0;
          background: url(../../../../assets/images/checke.png) no-repeat
            0.0625rem 0;
        }
      }
    }
      ...
      .item {
        ...
        div.right {
          ...
          .active {
            ...
            background: url(../../../../assets/images/mark-a.png) no-repeat
              0.1875rem 0.1875rem;
          }
        }
      }
