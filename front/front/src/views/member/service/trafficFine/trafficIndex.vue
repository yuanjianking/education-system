	...
	.content{
		li{
			...
			label{
				...
				text-align: left;
				line-height: 2.8125rem;
				i{ font-size: 25px;vertical-align: middle;color:#c9c9c9;}
			}
			...
			.traffic{
				...
				color:#8c8c8c;
				i{float: right; font-size: 25px;color:#c9c9c9;}
			}
			.other{color:#333}
			.hasright{border-right: 0.0625rem solid #ebebeb;}
		}
		.nobot{
			border-bottom:0;
	...
	.content{
		li{
			...
			label{
				...
				line-height: 2.8125rem;
				order: 2;
				i{ font-size: 25px;vertical-align: middle;}
			}
			input{border:0;outline: 0;}
			.traffic{
				order: 1;
				...
				line-height: 2.6875rem;
				color:#a5a5a5;
				i{float: left; font-size: 25px;color:#a5a5a5;}
			}
			.other{color:#333}
			.hasright{border-left: 0.0625rem solid #e2e2e2;}
		}
		.nobot{
			border-bottom:0;
			margin-bottom: 0.625rem;
