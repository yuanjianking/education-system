<template>
	<div id="ticketOrderDetail"  :class="'ticketOrderDetail'+$store.state.service.lang">
		...
		<div class="orderContent">
			...
			<p class="order total"> <span class="left"><b>{{language.total}}¥705</b></span> <span class="right">{{language.toPay}}</span> </p>
		</div> 
		<!--明细-->
...
.ticketOrderDetailch{
	...
	.orderContent{
		...
		.order{
			...
			b.right{font-size: 14px; color: #333;font-weight: normal;}
			span.right{
		...
		.gift{height: 2.8125rem; line-height: 2.8125rem;padding-right:0.875rem;font-size:16px;color:#333;
			font{color:#f15353;}
		}
		.total{
			position: fixed;
			...
			font-size:16px;
			border-top:solid 0.0625rem #ebebeb;
		.left{ line-height: 2.8125rem;color:#333;}
		.right{
		}
		}
	}
...
.ticketOrderDetailwei{
	...
	.flight{
		...
		.top{
			...
			span{float: right;padding-left: 0.25rem;}
		}
		.flightNum{
			background: #fff;
			height: 4.375rem;
	...
	.orderContent{
		...
		.order{
			...
			span.right{ border:0.0625rem solid #FF951B; color:#FF951B;
			display: inline-block ; }
		}
		/*.insurance{height: 2.8125rem; line-height: 2.8125rem;}*/
		.gift{height: 2.25rem; line-height: 2.25rem;}
		.total{
			height: 4.0625rem;
			.left{ line-height: 4.0625rem;}
			}
	}
