      ...
      <div class="header_box">
        ...
        <div class="innerbox" style="">
          <div class="innerbox-li">
            <div>客户数量（人）</div>
            <div style="font-weight:700;font-size:15px;line-height:1.35rem;">
              {{ myReferral.child_total }}
            </div>
            <div style="text-align:right">
              <img
                src="../../../assets/images/person@2x.png"
          ...
          <div class="innerbox-li">
            ...
            <div style="text-align:right">
              <img
                src="../../../assets/images/order@2x.png"
                style="width:2.5rem;height:1.5rem;"
              />
            </div>
          </div>
        ...
        <div
          style="padding:0.626rem 0.8125rem;color:#8c8c8c;text-align:left;font-size:0.8125rem"
        >
      ...
      <div class="info_list">
        <mt-navbar v-model="activeName">
          <mt-tab-item
            ...
            v-if="level1 && level1.is_show"
            >{{ labelValue1 }}</mt-tab-item
          >
          <mt-tab-item
            id="second"
            @click.native="handleClick"
            v-if="level2 && level2.is_show"
            >{{ labelValue2 }}</mt-tab-item
          >
          <mt-tab-item
            id="third"
            @click.native="handleClick"
            v-if="level3 && level3.is_show"
            >{{ labelValue3 }}</mt-tab-item
          >
        </mt-navbar>
        <mt-tab-container v-model="activeName">
          ...
          <mt-tab-container-item id="first" v-if="level1 && level1.is_show">
            ...
            <div class="list_box">
              ...
              <div
                class="list"
                v-for="(item, index) in new_content"
                :key="index"
              >
                <div class="list_top">
