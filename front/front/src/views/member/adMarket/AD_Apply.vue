      ...
      <div class="main">
        ...
        <yd-cell-item style="padding-bottom:0.625rem;">
          <yd-textarea slot="right"
                       ...
                       class="remark"
                       style="padding:10px;"></yd-textarea>
        </yd-cell-item>
...
export default {
  ...
  methods: {
    ...
    getStatus() {
      ...
      $http
        .get(
          "plugin.advert-market.frontend.advertMember.verify",
          {},
          "加载中..."
        )
        .then(
    ...
    submit() {
      ...
      $http
        .post(
          "plugin.advert-market.frontend.advertMember.subApply",
          { apply: this.apply },
          "提交中"
        )
        .then(
...
#adApply {
  ...
  .btnBox {
    ...
    display: flex;
    align-items: center;
    box-shadow: 0rem 0rem 0.313rem 0rem rgba(0, 0, 0, 0.2);
    span {
      width: 85%;
      height: 2.438rem;
