            ...
            getApplicationdata(){
                $http.get("plugin.yop-pay.api.merchant.newApply", {}, ).then(response => {
                    if (response.result == 1) {
                        ...
                        this.imageUrl_3=responseData.localInfo.CORP_CODE;
                        this.imageUrlData_3=responseData.info.CORP_CODE;
                        this.imageShowUrlData_3=responseData.localInfo.CORP_CODE;
