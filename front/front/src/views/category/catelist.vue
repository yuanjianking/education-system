        ...
        <ul class="sort_a"
          ...
          <li>
            ...
            <i class="iconfont icon-up"
               :class="{ hascolor: colorshow == '0_1' }"></i>
            <i class="iconfont icon-down"
               :class="{ hascolor: colorshow == '0_2' }"></i>
          </li>
        </ul>
        <ul class="sort_b"
            @click="getrank_1(1)">
          <li>
            ...
            <i class="iconfont icon-up"
               :class="{ hascolor: colorshow == '1_1' }"></i>
            <i class="iconfont icon-down"
               :class="{ hascolor: colorshow == '1_2' }"></i>
          </li>
        </ul>
        <ul class="sort_c"
            @click="getrank_1(2)">
          <li>
            ...
            <i class="iconfont icon-up"
               :class="{ hascolor: colorshow == '2_1' }"></i>
            <i class="iconfont icon-down"
               :class="{ hascolor: colorshow == '2_2' }"></i>
          </li>
        </ul>
        <div class="sort_icon">
