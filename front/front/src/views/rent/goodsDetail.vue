			...
			<div id="shopInfo" ref='goodinfo' :class="{goodTop:goodTop==true, 'pcStyle':fun.getPhoneEnv() == 3}">
				<div id="tabs">
					<mt-navbar v-model="activeName">
						<mt-tab-item id="first" @click.native="handleClick('0')" >商品介绍</mt-tab-item>
						<mt-tab-item id="second" @click.native="handleClick('1')">商品参数</mt-tab-item>
						<mt-tab-item id="third" @click.native="handleClick('2')" >用户评价</mt-tab-item>
					</mt-navbar>
