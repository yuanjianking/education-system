<template>
	<div id="confirmOrder">
				...
				<div class="maleall">
					<label for="male" class="males">
						...
						<!--<el-select v-model="provicevalue" placeholder="请选择省份" @change="selectProviceHandle">-->
							...
							<!--</el-option>-->
						<!--</el-select>-->
						<van-button plain type="primary" style="border-radius: 5px; color: #1f2d3d;border:1px solid #bfcbd9;min-height:1rem;min-width: 10rem" @click="seleRegional">{{regional}}</van-button>
					</label>
				</div>
				<div class="maleall">
					<label for="male" class="males">
						...
						<!--<el-select v-model="cityvalue" placeholder="请选择城市" @change="selectCityHandle">-->
							...
							<!--</el-option>-->
						<!--</el-select>-->
						<van-button plain type="primary" style="border-radius: 5px; color: #1f2d3d;border:1px solid #bfcbd9;min-height:1rem;min-width: 10rem"   :disabled="streetnull" @click="seleRegional_1">{{regiona2}}</van-button>
					</label>
				</div>
				<div class="maleall">
					<label for="male" class="males">
						...
						<!--<el-select v-model="regionvalue" placeholder="请选择区县" @change="selectRegionHandle">-->
							...
							<!--</el-option>-->
						<!--</el-select>-->
						<van-button plain type="primary" style="border-radius: 5px; color: #1f2d3d;border:1px solid #bfcbd9;min-height:1rem;min-width: 10rem"  :disabled="citynull" @click="seleRegional_2">{{regiona3}}</van-button>
					</label>
				</div>
		...
		<van-popup v-model="dateshow_2" position="bottom" :overlay="true">
			<van-picker :columns="columns_1" @change="onChange_1"  @cancel="onCancelbtn_1" @confirm="onConfirmbtn_1" show-toolbar/>
		</van-popup>
		<van-popup v-model="dateshow_3" position="bottom" :overlay="true">
			<van-picker :columns="columns_2" @change="onChange_2"  @cancel="onCancelbtn_2" @confirm="onConfirmbtn_2" show-toolbar/>
		</van-popup>
	</div>
</template>
