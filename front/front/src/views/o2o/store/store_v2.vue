<template>
  <div id="all"
    ...
    <div class="content" :style="{backgroundImage:'url('+store.store_barnner_thumb+')'}"
         v-show="!loadingPopup">
      <div class="search_top" >
        <i class="fa fa-angle-left" style="color: #fff"
           @click="goback"></i>
      ...
      <div class="storeInfo_box"
        ...
        <div class="coupon-box">
          <div class="coupon-left"><span class="red-span" v-if="i<4" v-for="(coupon, i) in get_coupon" :key="i">{{coupon.name}}</span></div>
      ...
      <div class="menu_evaluate_business">
                ...
                <viewer :images="comment.images">
                  <div style="overflow-x: scroll;overflow-y: hidden;">
                    <div class="img_box"
                         ref="imgbox">
                      <div class="img"
                           v-for="(img,i) in comment.images" :key='i'>
                        <img :src="img" />
                      </div>
                    </div>
                  </div>
                </viewer>
                <div class="goodlnfo" v-if="comment.has_one_goods"
                     @click="gotoGoodDetail(comment.has_one_goods.id)">
                  <img :src="comment.has_one_goods.thumb"
                       alt="">
                  <div class="goodMain">
                    <p class="titless">{{comment.has_one_goods.title}}</p>
                    <p class="price">￥{{comment.has_one_goods.price}}</p>
                  </div>
        ...
        <div class="store_box"  v-show="tabIndex === 2">
          <ul class="tab-box">
            <li v-for="(item, index) in tabList" :key="index" :class="tabIndex2 == item ? 'choose' : ''" @click="chooseTab(item)">{{item}}</li>
          </ul>
      ...
      <div class="Go_settle"
        ...
        <i class="iconfont icon-all_buycar"
           @click="trggleCart"></i>
        <p>购物车是空的</p>
        <button type="button"
      ...
      <div class="Go_settle complete"
        ...
        <i :style="minicartStyle"
           class="iconfont icon-all_buycar"
           @click="trggleCart"></i>
