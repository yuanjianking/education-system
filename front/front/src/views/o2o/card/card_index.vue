<template>
  <div id="card_index">
    <c-title :hide="false" text='一卡通'></c-title>
    <div id="content">
        <div class="content_a">
            <div class="card_equity">
                ...
                <h1>一卡通<span>尊享权益/PRIVLEGE</span></h1>
            </div>
            <!-- <ul class="equity">
                <li>
        ...
        <div class="content_b">
            ...
            <!-- <transition name="fade"> -->
                ...
                <div class="content_b_a" v-if="privilege_discount_show">
                    ...
                    <mt-loadmore v-if="pd_goload" :top-method="pdLoadTop" :bottom-method="pdLoadBottom" :bottom-all-loaded="pd_allLoaded" ref="pd_loadmore" bottomPullText='' bottomDropText='下拉加载...' bottomLoadingText='' :autoFill='false'>
            ...
            <transition name="fade">     -->
                <!-- 平日折扣 -->
                <!-- <div class="content_b_b" v-if="weekday_discount_show">
                    <div class="tab_b">
                        <ul class="tab_b_box">
                            <li v-for="(item,index) in pd_classfy_arr" :class="{current:index==wd_index}" @click="wdClassfySearch(index,item.id)">{{item.name}}</li>
                        </ul>
                    </div>
                    <div class="goods_list">
                        <mt-loadmore v-if="wd_goload" :top-method="wdLoadTop" :bottom-method="wdLoadBottom" :bottom-all-loaded="wd_allLoaded" ref="wd_loadmore" bottomPullText='' bottomDropText='下拉加载...' bottomLoadingText='' :autoFill='false'>
                            <div class="goods" v-for="item in wd_arr" @click="gotoShop(item.id)">
                                <div class="img">
                                    <img :src="item.thumb" style="width:100%;height:100%">
                                </div>
                                <ul class="info">
                                    ...
                                    <li class="info_c">
                                        <span v-if="!fun.isTextEmpty(item.discount)">{{item.discount}}折</span>
                                        <span v-else></span>
                                        <button type="button" @click="gotoShop(item.id)">立即使用</button>
                                    </li>
                                </ul>
            ...
            <transition name="fade"> -->
                ...
                <div class="content_b_c" v-if="exclusive_coupons_show">
                    <div class="coupon_box">
                        <mt-loadmore v-if="ec_goload" :top-method="ecLoadTop" :bottom-method="ecLoadBottom" :bottom-all-loaded="ec_allLoaded" ref="ec_loadmore" bottomPullText='' bottomDropText='下拉加载...' bottomLoadingText='' :autoFill='false'>
                            <div class="coupon" :key='i' v-for="(item,i) in ec_arr">
                                ...
                                <div class="right">
                                    ...
                                    <ul class="right_b">
                                        <li v-if="item.coupon_method==1">¥<span>{{item.deduct}}</span></li>
 ...
 #card_index{
   ...
   #content{
     ...
     .content_b{
       ...
       .content_b_a,.content_b_b,.content_b_c{
            .tab_b{
                background: #f5f5f5;
                overflow-x: scroll;
                white-space: nowrap;
