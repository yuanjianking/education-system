<template>
  <div id="replenish-order">
    <c-title :hide="false" text='补货单'></c-title>
    <!--补货商的补货单-->
      ...
      <!--<el-tabs v-model="activeName" @tab-click="getRebate">-->
        ...
        <!--<el-tab-pane label="全部" name="-1">-->
          <div class="order" v-if="!status">
            <div class="goods-list" v-for="(good,index) in list" @click="toDetail(good.id)" :key='index'>
...
<script>
  import replenish_orderlist_controller from './replenish_orderlist_controller';

  export default replenish_orderlist_controller;
</script>
