<template>
  <div id="goods-center">
    <c-title :hide="false" text="我要铺货"></c-title>
            ...
            <ul class="c_name">
              <li class="class_a">
                <span
                  ...
                  @click.stop="chooseCategory(list)"
                  >{{ list.name }}</span
                >
              </li>
              <li
                ...
                v-for="(child,i) in list.childrens"
				:key='i'
              >
                <span
...
<script>
import my_distribution from "./my_distribution_controller";

export default my_distribution;
</script>
