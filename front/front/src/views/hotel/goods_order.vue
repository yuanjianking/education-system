    ...
    <div id="goods_order">
        <c-title :hide="false" text='商品下单页' ></c-title>
            ...
            <ul class="detail_c">
                ...
                <li v-if="isInvoice && invoice_type == '2'"><input type="text" placeholder="请填写单位名称" v-model="company_name"></li>
            ...
            <ul class="detail_d">
                <li v-for="(item,index) in order_info.amount_items" :key='index'>
                    <span>{{item.name}}</span>
                    <span>¥<span v-if="item.code=='total_deduction_price'">-</span>{{item.amount}}</span>
                </li>
                <!-- <li>
                    <span>订单总金额</span>
                ...
                <li>
                    <span>总优惠</span>
                    <span>-¥{{order_info.total_discount_price}}</span>
                </li>
                <li>
                    <span>总抵扣</span>
                    <span>-¥{{order_info.total_deduction_price}}</span>
                </li> -->
            </ul>
...
开具发票。</p>
            ...
            <div class="foot" :style="{width: this.fun.getPhoneEnv() == 3 ? '375px' : ''}">
                <ul class="foot_a">
                    <li>合计：<span>¥<font>{{order_info.total_price}}</font></span></li>
                </ul>
