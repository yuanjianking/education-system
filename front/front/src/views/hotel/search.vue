      ...
      <div class="like_box">
        ...
        <div class="goods_box">
          <!-- <div class="goods">
                            ...
                            <ul class="info">
                                <li class="info_a" style="-webkit-box-orient: vertical;">维也纳国际酒店(广州机场路新市店) <font>经济型</font></li>
                                <li class="info_b"><span>4.8<font>棒</font></span>5000+人消费</li>
                                <li class="info_c">距我0.5km,汇创意产业园</li>
                                <li class="info_d">最新预定：1小时前</li>
                                <li class="info_e"><font>¥</font><span>160</span><font>起</font></li>
                            </ul>
                        </div> -->
          <mt-loadmore
            v-if="goload"
