    ...
    <div id="content">
      <div class="scroll_banner">
        <yd-slider autoplay="3000">
          <!-- <yd-slider-item v-if="fun.isTextEmpty(carousels_arr)">
                                    <a href="javascript:;">
                                        <img src="../../assets/images/loading.jpg">
                                    </a>
                                </yd-slider-item> -->
          <yd-slider-item v-for="(item,index) in carousels_arr" :key="index">
      ...
      <van-popup v-model="show1" position="bottom" transition="fade">
        <div class="price_box">
          <div class="price">
            <p class="title">
              价格<span>当前：¥{{ value }}</span>
            </p>
            <p class="number">
              <span>¥0</span>
              <span>¥700</span>
            </p>
            <!-- <van-slider v-model="value" :step="100" bar-height="4px" active-color="#f15353" :min="0" :max="700"/> -->
            <mt-range
              v-model="value"
              :min="0"
              :max="700"
