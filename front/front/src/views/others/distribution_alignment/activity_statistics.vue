  ...
  <div id="distribution">
    ...
    <div class="content">
      <div class="price">
        ...
        <span class="money">￥{{ total_income }}</span>
      </div>
      <div class="button">
    ...
    <div id="tabs">
      <mt-navbar v-model="activeName">
        <mt-tab-item id="first" @click.native="handleClick('3')"
          >全部</mt-tab-item
        >
        <mt-tab-item id="second" @click.native="handleClick('0')"
          >活动中</mt-tab-item
        >
        <mt-tab-item id="third" @click.native="handleClick('1')"
          >已完成</mt-tab-item
        >
        <mt-tab-item id="fourth" @click.native="handleClick('-1')"
          >失败</mt-tab-item
        >
      </mt-navbar>
      <mt-tab-container
      ...
      >
        <mt-tab-container-item id="first"> </mt-tab-container-item>
        <mt-tab-container-item id="second"> </mt-tab-container-item>
        <mt-tab-container-item id="third"> </mt-tab-container-item>
        <mt-tab-container-item id="fourth"> </mt-tab-container-item>
      </mt-tab-container>
      <div>
        <div>
          <div
