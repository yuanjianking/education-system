<template>
  <div class="result">
    ...
    <div class="content" v-if="show == 'person' && person.status == 'SUCCESS'">
      ...
      <div class="btn-box">
        ...
        <div class="btn-item">
          ...
          <div class="btn" style="width: 80%;color: #377aff;background: #FFFFFF;border: 1px solid #377aff;" @click="toSign('home')">返回合同中心</div>
        </div>
      </div>
    </div>
    <!--个人认证通过end-->
    ...
    <div class="btn" v-if="show == 'company' && company.status == 'SUCCESS'" style="width: 80%;color: #377aff;background: #FFFFFF;border: 1px solid #377aff;" @click="toSign('home')">返回合同中心</div>
    <!--企业认证通过end-->
    ...
    <div class="btn" v-if="show == 'company'&& company.status == 'ING'" style="width: 80%;color: #377aff;background: #FFFFFF;border: 1px solid #377aff;" @click="toSign('home')">返回合同中心</div>
    <!--企业认证审核end-->
  </div>
</template>
