            ...
            >
              <van-swipe-item v-for="(item, index) in redData" :key="index">
                <li>
                  <span>恭喜</span
                  ><span
                    style="width:4rem;overflow:hidden;text-overflow:ellipsis;white-space: nowrap;"
                    >{{ item.nick_name }}</span
...
.orderList {
  ...
  box-shadow: 0rem 0.22rem 0.75rem 0rem rgba(237, 93, 4, 0.75);
...
.tosTitle {
  ...
  height: 2rem;
  background-color: #ffffff;
  box-shadow: 0rem 0rem 1rem 0rem rgba(208, 16, 13, 0.75);
  border-radius: 1rem;
  color: #f77535;
  line-height: 2rem;
  font-family: PingFang-SC-Heavy;
