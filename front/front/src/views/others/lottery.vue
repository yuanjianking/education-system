<template>
  ...
  >
    ...
    <div class="logo" v-if="activityModel.is_logo">
    ...
    <div class="score">我的积分：{{ credit1 }}</div>
    <div class="prizers"  v-if="activityModel.is_roster">
      ...
      <div class="prizer">
        ...
        <div class="prizerList" id="prizerList">
          <ul id="prizerList1">
            <template v-for="item in prizers">
              <li v-if="item.member">
    ...
    <div class="home_box" @click.stop="showToolbar" style="bottom: 4.1875rem;">
