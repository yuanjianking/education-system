<template>
  <div id="advertisingPage">
      ...
      <div class="list_content">
        ...
        <ul class="box list7">
          <li>
            <div class="title7">
              <h3>积分</h3>
              <span>购物、推广、签到、任务奖励、抵扣、转让等活动让积分高效运转。</span>
            </div>
            <div class="img7">
    ...
    <div class="content" style="paddingBottom:5rem;">
      <img
...
.head {
  height: 13.75rem;
  background: url(../../assets/images/h5_top_bg@2x.png) center no-repeat scroll
    transparent;
...
.content .list_title {
  background: url(../../assets/images/list_title_bg@2x.png) center no-repeat
    scroll transparent;
...
.list_content .list7 li {
  ...
  box-shadow: 0px 0px 10px rgba(12, 203, 105, 0.4);
  align-items: center;
  padding: 1rem 0.2rem;
}
.list7 li .title7 {
